...
export interface ApiProductoProducto extends Schema.CollectionType {
  ...
  attributes: {
    codigo_barras: Attribute.Text & Attribute.Required;
    nombre: Attribute.String & Attribute.Required;
    ...
    marcas: Attribute.Relation<
      'api::producto.producto',
      'oneToMany',
      'api::marca.marca'
    >;
    entradas: Attribute.Relation<
      'api::producto.producto',
      'manyToMany',
      'api::entrada.entrada'
    >;
    porcentaje_ganancia: Attribute.Integer & Attribute.Required;
    salidas: Attribute.Relation<
      'api::producto.producto',
      'manyToMany',
      'api::salida.salida'
    >;
